    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-navy via-gray-900 to-black text-white">
      ...
      <section className="relative py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            <span className="text-brand-cyan">ComicCrypt</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Comics & Graphic Novels Management Platform
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-8">Join collectors worldwide using ComicCrypt to manage their comics & graphic novels.</p>
